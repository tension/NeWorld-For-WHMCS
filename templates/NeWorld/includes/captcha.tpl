                ...
                <div class="col-md-8 col-md-offset-2 col-xs-10 col-xs-offset-1">
                    <div id="default-captcha-domainchecker" class="{if $filename == 'domainchecker'}input-group input-group-box {/if}text-center">
                        ...
                        <div class="col-xs-6 captchaimage">
                            <img id="inputCaptchaImage" src="{$WEB_ROOT}/includes/verifyimage.php" align="middle" class="verifyimage" />
                        </div>
                ...
                {else}
                    <div class="text-center">
                        <div class="col-md-5 col-sm-5 col-xs-5 captchaimage">
                            <img src="{$WEB_ROOT}/includes/verifyimage.php" align="middle" class="verifyimage" />
                        </div>
