{foreach $navbar as $item}
    <li menuItemName="{$item->getName()}" class="left-menu__item{if $item->hasChildren()} dropdown more{elseif $item->getClass()} {$item->getClass()}{/if}" id="{$item->getId()}">
