...
<!-- Custom Styling -->
<link rel="stylesheet" href="{$WEB_ROOT}/templates/{$template}/assets/css/custom.css?v0.2.9">
<link rel="stylesheet" href="{$WEB_ROOT}/templates/{$template}/assets/css/color.css?v0.2.9">
