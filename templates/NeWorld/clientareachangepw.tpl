...
<form class="form-horizontal using-password-strength" method="post" action="clientarea.php?action=changepw" role="form">
    ...
    <div class="form-group">
        <label for="inputExistingPassword" class="col-xs-12 col-sm-3 control-label">{$LANG.existingpassword}</label>
        <div class="col-xs-12 col-sm-9 col-md-6">
            <input type="password" class="form-control" name="existingpw" id="inputExistingPassword" autocomplete="off" />
        </div>
    </div>
    <div id="newPassword1" class="form-group has-feedback">
        <label for="inputNewPassword1" class="col-xs-12 col-sm-3 control-label">{$LANG.newpassword}</label>
        <div class="col-xs-12 col-sm-9 col-md-6">
    ...
    <div id="newPassword2" class="form-group has-feedback">
        <label for="inputNewPassword2" class="col-xs-12 col-sm-3 control-label">{$LANG.confirmnewpassword}</label>
        <div class="col-xs-12 col-sm-9 col-md-6">
