...
{if $formaction != 'dologin.php' && $filename != 'logout' && $filename != 'pwreset' && $templatefile != 'homepage' && $templatefile != 'vps' && $templatefile != 'features' && $templatefile != 'pricing' && $filename != "cart"}
		<div class="navbar-collapse-inner {if $templatefile == 'clientareahome'}fixed{/if}">
	    ...
	    <div class="sub-menu {if $templatefile == 'clientareahome'}fixed{/if}">
	        {include file="$template/includes/sidebar.tpl" sidebar=$primarySidebar}
	    </div>
	    <div class="main-content {if $templatefile == 'clientareahome'}fixed{/if}">
