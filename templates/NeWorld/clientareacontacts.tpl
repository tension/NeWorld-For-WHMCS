{if $contactid}
    ...
    <form role="form" method="post" action="{$smarty.server.PHP_SELF}?action=contacts&id={$contactid}">
        ...
        <div class="form-group">
            ...
            <input class="btn btn-danger pull-right" type="button" value="{$LANG.clientareadeletecontact}" onclick="deleteContact('{$LANG.clientareadeletecontactareyousure}', {$contactid})" />
        </div>
